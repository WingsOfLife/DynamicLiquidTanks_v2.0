...
public class WorldGenHauntedTree extends WorldGenNewTreeBase {
	...
	public WorldGenHauntedTree(boolean par1) {
		super(par1);
	}
	...
	private boolean checkTree(World world, Random rand, int x, int y, int z) {
		...
		int heightID = world.getBlockId(x, y, z);
		if (heightID != BlockManager.BlockHD.blockID) return false;
