...
public class GenerateLiquids extends WorldGenerator
{
    ...
    public GenerateLiquids(int par1, int genId)
    {
        this.clayBlockId = genId;
                ...
                for (int j1 = par5 - l; j1 <= par5 + l; ++j1)
                {
                    ...
                    if (k1 * k1 + l1 * l1 <= l * l)
                    {
                        for (int i2 = par4 - b0; i2 <= par4 + b0; ++i2)
                        {
                            ...
                            if (j2 == Block.sand.blockID || j2 == Block.waterStill.blockID)
                            {
