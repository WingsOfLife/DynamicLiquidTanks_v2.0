       ...
       this.generateOres();
        ...
        if (doGen && this.generateLakes)
        {
            for (j = 0; j < 50; ++j)
            {
                ...
                i1 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
                (new WorldGenLiquids(FluidManager.poisonBlock.blockID)).generate(this.currentWorld, this.randomGenerator, k, l, i1);
            }
            ...
            for (j = 0; j < 20; ++j)
            {
                ...
                i1 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
                (new WorldGenLiquids(FluidManager.regenBlock.blockID)).generate(this.currentWorld, this.randomGenerator, k, l, i1);
            }
        }
