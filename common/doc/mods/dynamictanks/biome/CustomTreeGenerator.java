...
public class CustomTreeGenerator extends WorldGenerator {
    ...
    public CustomTreeGenerator(boolean par1)
    {
        this(par1, 4, 1, 1, false);
    }

    public CustomTreeGenerator(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
            ...
            else
            {
                ...
                if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID || var8 == BlockManager.BlockHD.blockID) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + var11, par5, FluidManager.blockType.get(par2Random.nextInt(FluidManager.blockType.size() - 1)).blockID, this.metaWood);
