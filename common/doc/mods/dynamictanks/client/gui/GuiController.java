...
public class GuiController extends GuiContainer
{
	...
	public void drawScreen(int mouseX, int mouseY, float par3) {
		...
		int elementXAddLeft        = 37;
		int elementXAddRight       = 55;
		...
		if (mouseX >= (centerX + elementXAddLeft) && mouseX <= (centerX + elementXAddLeft + elementWidth)) {
			...
			if (mouseY >= (centerY - elementYAddMiddle) && mouseY <= (centerY - elementYAddMiddle + elementHeight)) {
				List list = new ArrayList<String>();
				list.add(StringHelper.Cap(FluidHelper.getName(controller.getAllLiquids(), 2)));
				String s = EnumChatFormatting.DARK_GRAY + "" + FluidHelper.getFluidAmtIndex(controller.getAllLiquids(), 2);
				s =  s + " / " + controller.getTankCapacity() + " mB";
				list.add(s);
	...
	public void drawGuiContainerBackgroundLayer(float f, int i, int j)
	{
		...
		drawString(fontRenderer, StringHelper.Cap(FluidHelper.getName(controller.getAllLiquids(), controller.getLiquidIndex())) +  " :: " + FluidHelper.getFluidAmtIndex(controller.getAllLiquids(), controller.getLiquidIndex()) + " mB", guiLeft + 20, guiTop + 86, 0xFFFFFF);
	...
	protected void drawToolTip(List list, int par2, int par3)
	{
