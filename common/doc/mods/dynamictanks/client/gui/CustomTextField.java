...
public class CustomTextField extends Gui
{
    ...
    public CustomTextField(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5)
    {
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                //drawRect(this.xPos - 1, this.yPos - 1, this.xPos + this.width + 1, this.yPos + this.height + 1, -16777216);
