...
public class GuiUpgrade extends GuiContainer {
	...
	public GuiUpgrade (InventoryPlayer playerInventory, UpgradeTileEntity tileUpgrade) {
		super(new UpgradeContainer(playerInventory, tileUpgrade));
	}
