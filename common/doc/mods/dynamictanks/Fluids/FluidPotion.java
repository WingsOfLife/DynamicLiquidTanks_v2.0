...
public class FluidPotion extends BlockFluidClassic implements ITileEntityProvider
{
	...
	public FluidPotion(int id, Fluid fluid, Material material, String name, int metaAssociation)
	{
		...
		setUnlocalizedName("dynamictanks.fluids." + StringHelper.Cap(StringHelper.removeSpaces(name)));
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		...
		if (tile instanceof PotionTileEntity && isSourceBlock(par1World, par2, par3, par4)) {
			...
			if (list != null && !list.isEmpty())
				for (Object o : list)
					if (o instanceof PotionEffect)
						if (((EntityPlayer) par5Entity).isPotionActive(((PotionEffect) o).getPotionID()))
							return;
			PotionEffectHelper.applyPotionEffects((EntityPlayer) par5Entity, list, CPotionHelper.getDuration(potionTile.getPotency()), false);
