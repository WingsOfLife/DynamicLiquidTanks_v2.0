	 ...
	 */
	 ...
	 public Icon getBlockTexture(IBlockAccess world, int x, int y, int z, int dir) {
		 ...
		 if (tile != null && tile instanceof TankTileEntity) {
			 ...
			 try {
				 switch (dir) {
				 case 0: return tank.hasCamo() ? ConnectedTexturesHelper.blockIcon(tank.getCamo()[0], dir, tank.getCamo()[1]) 
						 : ConnectedTexturesHelper.getBlocksAroundToBo(world, x, y, z, dir, this.blockID); 
				 case 1:  return tank.hasCamo() ? ConnectedTexturesHelper.blockIcon(tank.getCamo()[0], dir, tank.getCamo()[1]) 
						 : ConnectedTexturesHelper.getBlocksAroundToBo(world, x, y, z, dir, this.blockID); 
				 case 2:  return tank.hasCamo() ? ConnectedTexturesHelper.blockIcon(tank.getCamo()[0], dir, tank.getCamo()[1]) 
						 : ConnectedTexturesHelper.getBlocksAroundNoSo(world, x, y, z, dir, this.blockID); 
				 case 3: return tank.hasCamo() ? ConnectedTexturesHelper.blockIcon(tank.getCamo()[0], dir, tank.getCamo()[1]) 
						 : ConnectedTexturesHelper.getBlocksAroundNoSo(world, x, y, z, dir, this.blockID); 
				 case 4: return tank.hasCamo() ? ConnectedTexturesHelper.blockIcon(tank.getCamo()[0], dir, tank.getCamo()[1]) 
						 : ConnectedTexturesHelper.getBlocksAroundEaWe(world, x, y, z, dir, this.blockID); 
				 case 5: return tank.hasCamo() ? ConnectedTexturesHelper.blockIcon(tank.getCamo()[0], dir, tank.getCamo()[1]) 
						 : ConnectedTexturesHelper.getBlocksAroundEaWe(world, x, y, z, dir, this.blockID); 
				 }
			 } catch (Exception e) {
				 return blockIcon;
