...
public class PotionRecipeInversion {
	...
	public static boolean addInversionRecipe(Types type, collisionType objId, int id, int invValue) {
		...
		switch (type) {
		case Fire_Resistance: fireInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Harming: harmingInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Healing: healingInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Invisibility: invisInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Night_Vision: nightInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Poison: poisonInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Regeneration: regenInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Slowness: slownessInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Strength: strengthInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Swiftness: swiftInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Water_Breathing: waterInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		case Weakness: weakInversionValues.add(new int[] { objId.getValue(), id, invValue });
			break;
		}
