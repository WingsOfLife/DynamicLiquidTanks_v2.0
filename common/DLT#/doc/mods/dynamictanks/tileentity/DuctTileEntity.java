...
public class DuctTileEntity extends TickingTileEntity
{
    ...
    public boolean isBlockThere(int direction)
    {
        ...
        switch (direction)
        {
            case directionValues.DOWN:
                return blockInDir[directionValues.DOWN] == TRUE;

            case directionValues.UP:
                return blockInDir[directionValues.UP] == TRUE;

            case directionValues.NORTH:
                return blockInDir[directionValues.NORTH] == TRUE;

            case directionValues.SOUTH:
                return blockInDir[directionValues.SOUTH] == TRUE;

            case directionValues.WEST:
                return blockInDir[directionValues.WEST] == TRUE;

            case directionValues.EAST:
                return blockInDir[directionValues.EAST] == TRUE;
        }
