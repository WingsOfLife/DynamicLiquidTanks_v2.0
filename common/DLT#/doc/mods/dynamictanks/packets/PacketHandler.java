...
public class PacketHandler implements IPacketHandler
{
	...
	public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player player)
	{
		...
		else if (id == PacketHandler.PacketIDs.syncCapacity) {
			ControllerTileEntity controllerTE = (ControllerTileEntity) world.getBlockTileEntity(x, y, z);
			controllerTE.powerOf = (int) meta;
		}
